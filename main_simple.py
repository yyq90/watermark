...
img = cv2.imread('images2_processed/fotolia_26734091.jpg')
...
alph_image = MatrixToImage(alph)
alph_image.save('alph_raw.jpg')
alph_image = MatrixToImage(Wm)
alph_image.save('Wm_raw.jpg')
